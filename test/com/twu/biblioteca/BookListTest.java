...
//
//    @Test
//    public void returnsAnArrayListOfBooksInStock() throws Exception {
//
//        testList.add(bookItem);
//
//        context.checking(new Expectations() {{
...
//        }});
//
//        assertEquals(testList, new BookList(testList).returnBooksInStock());
//    }
//
//    @Test
//    public void doesNotReturnBooksThatAreNotInStockInArrayList() throws Exception {
//
//        testList.add(bookItem);
//
//        context.checking(new Expectations() {{
...
//                result.add(bookItem);
//
//        assertEquals(result, new BookList(testList).returnBooksInStock());
//    }
//
////    @Test
